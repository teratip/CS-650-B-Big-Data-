...
# Arithmetic 
# 1.Add two vectors of the same length
X <- c( 1, 2, 3)
X
Y <- c( 4, 5 , 6 )
Y
...
# Calculate Celsius temperatures from Fahrenheit
cel = (fahrenheit - 32) * 5/9
cel

# Calculate the highest, lowest, and average temperatures in Fahrenheit
