...
# Visualizing car mpg and cylinder count distribution.
data(mtcars)
...
# Stem-and-leaf plot, and histogram for x Variable.
...
summary(nicediamonds$cut) #summarizing cut types
...
# Creating matrices by sticking vectors together using rbind and cbind:
r1 <- c("I", "am","happy")
r2 <- c ("what", "a", "day")
r3 <-1:3
...
#Try it yourself by changing the length of r1,r2,or r3
r1 <- c("I", "am", "happy")
